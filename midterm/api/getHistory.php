...
function get_matches()
{
    ...
    $sql = "SELECT answer_timestamp as timestamp, username, answer_type_id, picture_url from `match` inner join user on `match`.match_user_id=user.id where `match`.user_id = :id";
